...
public interface CategoriesApi {
     ...
     *
     * @param categoryId The id of the item to retrieve (required)
    ...
    default ResponseEntity<CategoryDto> showCategoryById(
        @Parameter(name = "categoryId", description = "The id of the item to retrieve", required = true, in = ParameterIn.PATH) @PathVariable("categoryId") Long categoryId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
